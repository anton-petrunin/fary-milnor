...
The restriction $f|_{\partial \mathbb{D}}$ as well as its image can be referred as the \emph{boundary} of the disc.

A disc $\Sigma$ is called area-minimizing if it has the smallest area among the surfaces with the given boundary.
