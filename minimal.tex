...
We will also apply the \emph{Doublas--Rado theorem} on the existence of area-minimizing disc and reuse the inequality between total curvature and angular length from F\'ary's proof.

A map from a domain of $\mathbb{R}^2$ to $\mathbb{R}^3$ will be called a \emph{surface};
...
At the same time, the original formulation admits generalization to a wider class of ambient spaces \cite{St_structure}.
