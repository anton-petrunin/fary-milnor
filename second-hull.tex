...
To show that Theorem \ref{thm:2nd-hull} implies our main theorem, we will apply the spherical Crofton formula:
...
If a polygonal line $\beta$ is inscribed in $\alpha$, then $h_2(\beta)\subset h_2(\alpha)$.
\end{thm}
