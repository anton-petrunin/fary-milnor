...
This observation suggests the following definition of the \emph{second hull} $h_2(\alpha)$:
...
plus any open half-space containing $\alpha$ will be called essential as well.
...
Finally observe that if a plane in general position has crossing number 2, then it bounds an essential half-space. 
